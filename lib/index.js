...
class Converter {
    ...
    constructor(options) {
        ...
        this.hast_to_html = { allowDangerousHtml: true, allowDangerousCharacters: true, useNamedReferences: true };
        ...
        const hast_mdast_hdl = [hastToMdastListType, tmp_li_bugfix];
    ...
    markdown_to_html(md) {
        ...
        const hast = mdastToHast(mdast, this.mdast_to_hast);
